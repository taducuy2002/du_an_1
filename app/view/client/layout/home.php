        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h2 class="title-border">GIÀY THỂ THAO ADIDAS</h2>
                </div>
                    ...
                    <div class="single-product">
                        ...
                        <div class="product-info clearfix">
                            <div class="fix">
                                ...
                                <p class="floatright hidden-sm d-none d-md-block">WELCOME TO OUR</p>
                            </div>
                            <div class="fix">
                                <span class="pro-price floatleft">1000.000</span>
...
<div class="purchase-online-area pt-80">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h2 class="title-border">CÁC THƯƠNG HIỆU KHÁC</h2>
                </div>
            </div>
        </div>
        <div class="row">
...
<div class="blog-area pt-55">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h2 class="title-border">MẪU GIÀY ĐẾN TỪ THƯƠNG HIỆU ADIDAS</h2>
                </div>
            </div>
        </div>
        <!-- Section-title end -->

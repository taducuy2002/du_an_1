                ...
                <div class="col-lg-12">
                    <div class="discount-product">
                        ...
                        <div class="discount-img-brief">
                            <div class="onsale">
                                <span class="onsale-text">On Sale</span>
                                <span class="onsale-price">$ 500</span>
                            </div>
                            <div class="discount-info">
                                <h1 class="text-dark-red d-none d-md-block">Discount 50%</h1>
                                <p class="d-none d-md-block">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed does eiusmodes tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim venim, quis nostrud exercitation ullamco laboris.</p>
...
<div class="blog-area pt-55">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h2 class="title-border">XEM TẤT CẢ SẢN PHẨM TẠI ĐÂY</h2>
                </div>
                <div class="row">
                            ...
                            <div class="blog-info">
                                <div class="post-meta fix">
                                    ...
                                    <div class="post-year floatleft">
                                        ...
                                        <h4 class="post-title"><a href="#" tabindex="0">Shop sỉ lẻ các loại giày cao cấp</a></h4>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-6 col-md-7">
                            <div class="blog-info">
                                <div class="post-meta fix">
                                    ...
                                    <div class="post-year floatleft">
                                        <p class="text-uppercase text-dark-red mb-0">June, 2024</p>
                                        <h4 class="post-title"><a href="#" tabindex="0">Cửa hàng cung cấp sản phẩm dành cho giới trẻ</a></h4>
                                    </div>
                                </div>
                                <div class="like-share fix">
                                    <a href="#"><i class="zmdi zmdi-favorite"></i><span>89 Like</span></a>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    <div class="footer-thumb">
                                        ...
                                        <div class="footer-thumb-info">
                                            <p><a href="#">Hàng chất lượng xịn<br>Xò</a></p>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="footer-thumb">
                                        ...
                                        <div class="footer-thumb-info">
                                            <p><a href="#">Giày chất lượng<br>Cao</a></p>
                                            <h4 class="price-3">$ 60.00</h4>
                                        </div>
                                    </div>
                                </div>

													...
													<table>
														...
														<tbody>
                                                            ...
                                                            foreach ($_SESSION['mycart'] as $cart) {
                                                                ...
                                                                $tong += $tongtien;
                                                                $xoasp = '<a href = "index.php?act=delecart&idcart= '.$i.'"><input type="button"  value="Xóa "></a>';
                                                                echo ' <tr>
																<td class="product-thumbnail  text-left">
																	
																	<div class="single-product">
																		<div class="product-img">
																			<a href="index.php?act=spchitiet&idsp><img src="'.$hinh.'" alt="" /></a>
																		</div>
																		<div class="product-info">
																			<h4 class="post-title"><a class="text-light-black" href="#">'.$ten_san_pham.'</a></h4>
																...
																<td class="product-subtotal">'.$gia.'</td>
